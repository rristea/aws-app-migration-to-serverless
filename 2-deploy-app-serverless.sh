...
echo "Copy Workflow definition to S3"
aws s3 cp app-serverless/workflow-definition.asl.json s3://app-serverless-s3-bucket-s3bucket/ --sse AES256

echo "Deploy Workflow StepFunction"
./create-stack.sh app-serverless/workflow-stepfunction.yml
